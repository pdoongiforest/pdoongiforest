...
function MapSearchPopup({ onClose }: Props) {
  ...
  const [searchList, setsearchList] = useState<kakao.maps.services.PlacesSearchResult>([]);
  ...
  return (
    <div className={S.popup} ref={modalRef}>
      <div className={S.searchBar}>
        ...
        <input type="text" placeholder="검색어를 입력해주세요." onKeyDown={handleSearch} />
                    ...
                    <li key={place.id}>
                      ...
                      >
                        <div>
                          ...
                          <p className={S.addressDetail}>{place.address_name}</p>
                        </div>
                      </a>
                    </li>
                  );
